...
public class MybatisReviewController extends BaseController {
    ...
    public AjaxResult saveData(@PathVariable String name, @PathVariable String age, @PathVariable String sex) {
        return AjaxResult.success(reviewService.save(name, age, sex));
    }
    /**=========================================================删除数据=============================================*/
